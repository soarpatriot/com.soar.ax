...
<html>
  ...
  <body onload="document.getElementById('soldTo').focus();">
        ...
        <h2>Lenovo OVP Client 1.6</h2>
  	    <h4><a href="javascript: jumpToOVP();" title="Click here to Levnovo OVP" onclick="">Order Report Portal</a></h4>
  	    <div class="row">
  	       <div class="span12">
  	       		 <form class="form-inline">
					  <input type="text" class='input-xlarge' placeholder="Text input">
				 </form>
  	       </div>
  	    </div>
  	    ...
  	    <form class="well form-inline form-horizontal">
	        ...
	        <div class="control-group">
	            ...
	            <div class="controls">
	                <input type="text" name="soldTo" id="soldTo" value="" onblur="procMsg(this, 2);"/>&nbsp;<span id="msg2" style="color: red;display: none;">Please enter soldTo when request system is not webUI</span>
	            </div>
	        </div>
	        <div class="control-group">
	            <label class="control-label" for="cipher">Cipher</label>
	            <div class="controls">
	                <input type="text" name="cipher" id="cipher" value=""/>&nbsp;<span id="cpSpan" style="color: red;display: none;">Access to the production environment, Please enter cipher</span>
	            </div>
	        </div>
	        <div class="control-group">
